...
final class PackingScreen extends CompatGuiBase {
    ...
    private void line(GuiContext c, String text, int y, int color) {
        c.drawString(textRenderer, textRenderer.plainSubstrByWidth(text, Math.max(1, width - 24)), 12, y, color);
    }
}
