...
public final class AutoStockClient implements ClientModInitializer {
    ...
    @Override public void onInitializeClient() {
        ...
        net.fabricmc.fabric.api.client.rendering.v1.hud.HudElementRegistry.addLast(
                net.minecraft.resources.Identifier.fromNamespaceAndPath("autostock", "hud"),
                (context, counter) -> {
                    var client = net.minecraft.client.Minecraft.getInstance();
                    if (client.level != null && ClientMinecraftCompat.screen(client) == null)
        ...
        ClientCommandRegistrationCallback.EVENT.register((dispatcher, access) -> dispatcher.register(
                literal("autostock")
                        .executes(context -> {
                            ...
                            context.getSource().getClient().execute(() -> ClientMinecraftCompat.setScreen(context.getSource().getClient(), new DraftScreen(draft)));
                            return 1;
                        })
                        ...
                        .then(literal("load").then(argument("task", net.minecraft.commands.arguments.UuidArgument.uuid())
