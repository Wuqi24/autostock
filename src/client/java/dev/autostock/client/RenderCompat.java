...
final class RenderCompat {
    ...
    static void drawBox(MatrixStack matrices, VertexConsumer vertices,
        ...
        *///?} else if <=1.21.10 {
        VertexRendering.drawBox(
                ...
                *///?}
                ...
                red, green, blue, alpha);
        //?} else {
        /*drawBoxLines(matrices.peek(), vertices, minX, minY, minZ, maxX, maxY, maxZ,
                red, green, blue, alpha);
        *///?}
    }

    static void drawVector(MatrixStack matrices, VertexConsumer vertices, Vector3f start, Vec3d vector, int color) {
        //? if <=1.21.1 {
        ...
        *///?} else if <=1.21.10 {
        ...
        //?} else {
        /*line(matrices.peek(), vertices, start.x, start.y, start.z,
    ...
    private static void drawBoxLines(MatrixStack.Entry entry, VertexConsumer vertices,
    ...
    private static void line(MatrixStack.Entry entry, VertexConsumer vertices,
        ...
        vertices.vertex(entry, (float) x1, (float) y1, (float) z1).color(red, green, blue, alpha).normal(entry, nx, ny, nz);
        vertices.vertex(entry, (float) x2, (float) y2, (float) z2).color(red, green, blue, alpha).normal(entry, nx, ny, nz);
    }
}
