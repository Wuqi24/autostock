...
import fi.dy.masa.malilib.gui.GuiBase;import net.minecraft.client.gui.DrawContext;
final class PreviewLibrary extends CompatGuiBase {
 ...
 @Override protected void drawScreenBackgroundCompat(DrawContext c,int x,int y){c.fill(0,0,width,height,0xA0000000);}
 @Override protected void drawContentsCompat(DrawContext c,int x,int y,float d){c.drawText(textRenderer,"从 Litematica 已加载的原理图中选择：",14,42,0xFFAAAAAA,false);}
}
