...
final class HudPositionScreen extends CompatGuiBase {
    ...
    private void drawMenu(DrawContext c){
        int id=menu;
    ...
    private void drawButton(DrawContext c,int x,int y,int width,int height,String label,int background){
    ...
    //?} else {
    /*@Override public boolean mouseClicked(net.minecraft.client.gui.Click click,boolean doubled){return handleMouseClicked(click.x(),click.y(),click.button())||super.mouseClicked(click,doubled);}
    @Override public boolean mouseDragged(net.minecraft.client.gui.Click click,double dx,double dy){return handleMouseDragged(click.x(),click.y())||super.mouseDragged(click,dx,dy);}
    @Override public boolean mouseReleased(net.minecraft.client.gui.Click click){dragging=-1;draggingOpacity=false;return super.mouseReleased(click);}
    *///?}
}
